...
### 17. Неуспешное оформление покупки тура единым платежом с незаполненным полем "Год"
...
### 18. Неуспешное оформление покупки тура единым платежом при введении в поле "CVC/CVV" значения из 1 цифры
...
### 19. Неуспешное оформление покупки тура единым платежом при введении в поле "CVC/CVV" значения из 2 цифр
...
### 20. Неуспешное оформление покупки тура единым платежом с незаполненным полем "CVC/CVV"
...
### 21. Неуспешное оформление покупки тура единым платежом при введении в поле "Владелец" значения из 1 слова
...
### 22. Неуспешное оформление покупки тура единым платежом при введении в поле "Владелец" значения, написанного кириллицей
...
### 23. Неуспешное оформление покупки тура единым платежом при введении в поле "Владелец" значения с использованием спецсимволов
...
### 24. Неуспешное оформление покупки тура единым платежом при введении в поле "Владелец" значения, состоящего из цифр
...
### 25. Неуспешное оформление покупки тура единым платежом при незаполненном поле "Владелец"
...
### 26. Успешная заявка на оплату тура при покупке в кредит одобренной картой
...
### 27. Неуспешное оформление заявки на покупку тура в кредит при использовании отклоненной карты
...
### 28. Неуспешное оформление заявки на покупку тура в кредит при использовании невалидной карты (16 нулей)
...
### 29. Неуспешное оформление заявки на покупку тура в кредит при введении слишком короткого номера карты (1 цифра)
...
### 30. Неуспешное оформление заявки на покупку тура в кредит при введении слишком короткого номера карты (15 цифр)
...
### 31. Неуспешное оформление заявки на покупку тура в кредит при незаполненном поле "Номер карты"
...
### 32. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Месяц" нулей
...
### 33. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Месяц" значения больше 12
...
### 34. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Месяц" значения намного больше 12
...
### 35. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Месяц" одной цифры
...
### 36. Неуспешное оформление заявки на покупку тура в кредит при незаполненном поле "Месяц"
...
### 37. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Год" истёкшего срока
...
### 38. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Год" предыдущего года
...
### 39. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Год" значения, большего текущего на 6
...
### 40. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Год" значения, намного большего значения текущего года
...
### 41. Неуспешное оформление заявки на покупку тура в кредит с незаполненным полем "Год"
...
### 42. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "CVC/CVV" значения из 1 цифры
...
### 43. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "CVC/CVV" значения из 2 цифр
...
### 44. Неуспешное оформление заявки на покупку тура в кредит с незаполненным полем "CVC/CVV"
...
### 45. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Владелец" значения из 1 слова
...
### 46. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Владелец" значения, написанного кириллицей
...
### 47. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Владелец" значения с использованием спецсимволов
...
### 48. Неуспешное оформление заявки на покупку тура в кредит при введении в поле "Владелец" значения, состоящего из цифр
...
### 49. Неуспешное оформление заявки на покупку тура в кредит при незаполненном поле "Владелец"
